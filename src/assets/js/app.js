...
const allCategories = [
  { 
      ...
      link: `/contact?category=${encodeURIComponent("Financial Assistance")}`, 
      description: [
  ...
  { 
      ...
      link: `/contact?category=${encodeURIComponent("Technology & Digital Services")}`,
      description: [
  ...
  { 
      ...
      link: `/contact?category=${encodeURIComponent("Location & Navigation Assistance")}`,
      description: [
  ...
  { 
      ...
      link: `/contact?category=${encodeURIComponent("Legal & Government Services")}`, 
      description: [
  ...
  { 
      ...
      link: `/contact?category=${encodeURIComponent("Travel & Transportation")}`,
      description: [
  ...
  { 
      ...
      link: `/contact?category=${encodeURIComponent("Consumer & Shopping Assistance")}`,
      description: [
  ...
  { 
      ...
      link: `/contact?category=${encodeURIComponent("Healthcare & Wellness")}`,
      description: [
  ...
  { 
      ...
      link: `/contact?category=${encodeURIComponent("Education & Career Guidance")}`,
      description: [
...
function initializeCategories(limit = 5) {
  const categoryList = document.getElementById("categoryList");
  categoryList.innerHTML = "";

  allCategories.slice(0, limit).forEach(cat => {
      const categoryDiv = document.createElement("div");
      categoryDiv.classList.add("category");

      let descriptionContent = `<ul class="description">${cat.description.map(item => `<li>${item}</li>`).join("")}</ul>`;

      categoryDiv.innerHTML = `
          <div class="icon"><i class="${cat.icon}"></i></div>
          <h2 class="column-title">${cat.title}</h2>
  ...
  document.getElementById("viewAllBtn").style.display = limit < allCategories.length ? "block" : "none";
  document.getElementById("showLessBtn").style.display = limit === allCategories.length ? "block" : "none";
}

function showAllCategories() {
  initializeCategories(allCategories.length);
}
